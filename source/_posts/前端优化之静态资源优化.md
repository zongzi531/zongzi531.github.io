...
categories: "Tools"
comments: true
thumbnail: /gallery/前端优化之静态资源优化/pic.jpg
tags:
- 优化
- gulp
---
...
gulp.task('minify-css', function() {
    return gulp.src('/gallery/public/**/*.css')
        .pipe(minifycss())
        .pipe(gulp.dest('/gallery/public'));
});

// 压缩 public 目录 html
gulp.task('minify-html', function() {
    return gulp.src('/gallery/public/**/*.html')
        .pipe(htmlclean())
        .pipe(htmlmin({
...
gulp.task('minify-js', function() {
    return gulp.src('/gallery/public/**/*.js')
        .pipe(uglify())
        .pipe(gulp.dest('/gallery/public'));
});
